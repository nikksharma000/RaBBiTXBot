...
from Imshivaexe.powers import *
from Imshivaexe import Bunny

telegraph = Telegraph()
r = telegraph.create_account(short_name="RaBBiTX")
auth_url = r["auth_url"]


@Bunny.on_message(filters.command(["tgm", "telegraph"], hl) & filters.me)
async def uptotelegraph(client: Client, message: Message):
    bunny = await message.edit("`ρɾσƈҽʂʂιɳɠ...⚡`")
